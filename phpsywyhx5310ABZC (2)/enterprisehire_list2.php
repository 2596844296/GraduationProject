...
<table class="table table-bordered table-hover">
  ...
  <?php 
   $sql="select * from enterprisehire where signupby='".$_SESSION['username']."'";
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<div class="btn-group">
	<a href="enterprisehiredetail.php?id=<?php echo mysql_result($query,$i,id);?>" class='btn btn-xs btn-info' data-toggle='tooltip' data-placement='top' title='详细' target='_blank'><i class='fa fa-info-circle'></i></a>
     <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=enterprisehire" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a><a href="enterprisehire_updt.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-pencil"></i></a>
    </div>
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='enterprisehire_list2.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 ><a href="enterprisehire_list2.php?pagecurrent=<?php echo $fyi;?>"><?php echo $fyi;?></a></li> 
	 <?php
	 }
	 ?>
	 
	 <li><a href="enterprisehire_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
