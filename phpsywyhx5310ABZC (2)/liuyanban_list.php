...
<body>
    <div id="body">
        ...
        <div class="barboxs">
            <button class="btn btn-success pull-left" data-toggle="tooltip" title="" data-placement="right" onClick="location.href='liuyanban_listxls.php';" style="cursor:pointer"
           ...
           <div class="leftbox" >
			<form action="" method="post">
			 <div class="leftbox" >
              	  <div class='liselect'><input name="zhanghao" type="text" id="zhanghao" class="form-control example-typeahead" placeholder='账号' style='width:120px;' /></div>
                <div class="liselect ">
         ...
         <div class="push">
            <button class="btn btn-success pull-left" onClick="location.href='liuyanban_add.php';"><i class="fa fa-plus"></i> 发布新数据 </button>
        </div> 
 <div class="tablebox">
...
<table class="table table-bordered table-hover">
  <tr>
	...
	<input name="tablename" type="hidden" id="tablename" value="liuyanban" /><input name="comew" type="hidden" id="comew" value="liuyanban_list" />
	</th>
	<th >序号</th>
    <th>账号</th>
    <th>照片</th>
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
    ...
    <td><img src="img/<?php echo mysql_result($query,$i,zhaopian);?>.gif" width="50" height="50"  /></td>
    ...
    <a href="liuyanban_huifu.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="回复"><i class="fa fa-pencil"></i></a>
    <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=liuyanban" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                            </div>
 </td>
  </tr>
  	<?php
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='liuyanban_list.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 <li><a href="liuyanban_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
