...
<body>
    <div id="body">
        ...
        <div class="barboxs">
            <button class="btn btn-success pull-left" data-toggle="tooltip" title="" data-placement="right" onClick="location.href='hiresignup_listxls.php';" style="cursor:pointer"
...
<table class="table table-bordered table-hover">
  <tr>
	...
	<input name="tablename" type="hidden" id="tablename" value="hiresignup" /><input name="comew" type="hidden" id="comew" value="hiresignup_list" />
	</th>
	<th >序号</th>
    <th>报名人</th>    <th>岗位编号</th>    <th>岗位名称</th>    <th>学历要求</th>    <th>企业名称</th>    <th>联系电话</th>    <th>企业地址</th>    
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<div class="btn-group">
<a href="hiresignupdetail.php?id=<?php echo mysql_result($query,$i,id);?>" target="_blank" class='btn btn-xs btn-info' data-toggle='tooltip' data-placement='top' title='前台预览'><i class='fa fa-info-circle'></i></a>
    <a href="hiresignup_updt.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-pencil"></i></a>
    <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=hiresignup" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                            </div>
 </td>
  </tr>
  	<?php
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='hiresignup_list.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 ><a href="hiresignup_list.php?pagecurrent=<?php echo $fyi;?>"><?php echo $fyi;?></a></li> 
	 <?php
	 }
	 ?>
	 <li><a href="hiresignup_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
