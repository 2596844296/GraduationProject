...
<body>
    <div id="body">
        ...
        <div class="barboxs">
            <button class="btn btn-success pull-left" data-toggle="tooltip" title="" data-placement="right" onClick="location.href='goodstypes_listxls.php';" style="cursor:pointer"
		...
		<div class='push'><button class='btn btn-success pull-left' onClick="location.href='goodstypes_add.php';"><i class='fa fa-plus'></i> 发布新数据 </button></div>
 <div class="tablebox">
 <form name="form2" method="post" action="delall.php"> 	
<table class="table table-bordered table-hover">
  <tr>
     <th ><input name="plxz" type="checkbox" id="plxz" onClick="checkall();" value="1" />
	<input name="tablename" type="hidden" id="tablename" value="goodstypes" /><input name="comew" type="hidden" id="comew" value="goodstypes_list" />
	</th>
	<th >序号</th>
    <th>类型</th>    
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
    ...
    <a href="goodstypes_updt.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-pencil"></i></a>
    <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=goodstypes" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                            </div>
 </td>
  </tr>
  	<?php
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='goodstypes_list.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 ><a href="goodstypes_list.php?pagecurrent=<?php echo $fyi;?>"><?php echo $fyi;?></a></li> 
	 <?php
	 }
	 ?>
	 <li><a href="goodstypes_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
