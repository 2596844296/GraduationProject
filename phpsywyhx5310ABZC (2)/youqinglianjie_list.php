...
<body>
    <div id="body">
        ...
        <div class="barboxs">
            <button class="btn btn-success pull-left" data-toggle="tooltip" title="" data-placement="right" onClick="location.href='youqinglianjie_listxls.php';" style="cursor:pointer"
           ...
           <div class="leftbox" >
			<form action="" method="post">
			 <div class="leftbox" >
              	  <div class='liselect'><input name="wangzhanmingcheng" type="text" id="wangzhanmingcheng" class="form-control example-typeahead" placeholder='网站名称' style='width:120px;' /></div> <div class='liselect'><input name="wangzhi" type="text" id="wangzhi" class="form-control example-typeahead" placeholder='网址' style='width:120px;' /></div>
                <div class="liselect ">
         ...
         <div class="push">
            <button class="btn btn-success pull-left" onClick="location.href='youqinglianjie_add.php';"><i class="fa fa-plus"></i> 发布新数据 </button>
        </div> 
 <div class="tablebox">
 <form name="form2" method="post" action="delall.php"> 	
<table class="table table-bordered table-hover">
  <tr>
     <th width="123" ><input name="plxz" type="checkbox" id="plxz" onClick="checkall();" value="1" />
	<input name="tablename" type="hidden" id="tablename" value="youqinglianjie" /><input name="comew" type="hidden" id="comew" value="youqinglianjie_list" />
	</th>
	<th width="95" >序号</th>
    <th width="183">网站名称</th>
    <th width="213">网址</th>
    <th>logo</th>
    
	
    <th align="center">添加时间</th>
    <th width="85" class="cell-small text-center"><i class="fa fa-bolt"></i> 操作</th>
  </tr>
  <?php 
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
    ...
    <td width='212'><a href="<?php echo mysql_result($query,$i,logo) ?>" target='_blank'><img src='<?php echo mysql_result($query,$i,logo) ?>' width='180' height='50' border='0'></a></td>
    ...
    <a href="youqinglianjie_updt.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-pencil"></i></a>
    <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=youqinglianjie" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
            </div>
 </td>
  </tr>
  	<?php
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='youqinglianjie_list.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 <li><a href="youqinglianjie_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
