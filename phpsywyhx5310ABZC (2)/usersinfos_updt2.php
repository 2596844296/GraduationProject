...
if ($addnew=="1" )
{
	...
	$sql="update usersinfos set usernames='$usernames',names='$names',gender='$gender',pwd='$pwd',phone='$phone',idcard='$idcard',memo='$memo' where usernames= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<?php
$sql="select * from usersinfos where usernames='".$_SESSION["username"]."'";
