...
<body>
    <div id="body">
        ...
        <div class="barboxs">
            <button class="btn btn-success pull-left" data-toggle="tooltip" title="" data-placement="right" onClick="location.href='goodsinfos_listxls.php';" style="cursor:pointer"
           ...
           <div class="leftbox" >
			<form action="" method="post">
			 <div class="leftbox" >
              	  <div class='liselect'><input name="goodsnumbers" type="text" id="goodsnumbers" class="form-control example-typeahead" placeholder='产品编号' style='width:120px;' /></div><div class='liselect'><select id='goodstypes' name='goodstypes' class='form-control'><option value="">所有</option><?php getoption("goodstypes","types")?></select></div>
                <div class="liselect ">
		...
		<div class='push'><button class='btn btn-success pull-left' onClick="location.href='goodsinfos_add.php';"><i class='fa fa-plus'></i> 发布新数据 </button></div>
 <div class="tablebox">
 <form name="form2" method="post" action="delall.php"> 	
<table class="table table-bordered table-hover">
  <tr>
     <th ><input name="plxz" type="checkbox" id="plxz" onClick="checkall();" value="1" />
	<input name="tablename" type="hidden" id="tablename" value="goodsinfos" /><input name="comew" type="hidden" id="comew" value="goodsinfos_list" />
	</th>
	<th >序号</th>
    <th>产品编号</th>    <th>产品类别</th>    <th>产品名称</th>    <th>产品图片</th>    <th>库存</th>    
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<div class="btn-group">
<a href="goodsinfosdetail.php?id=<?php echo mysql_result($query,$i,id);?>" target="_blank" class='btn btn-xs btn-info' data-toggle='tooltip' data-placement='top' title='前台预览'><i class='fa fa-info-circle'></i></a>
    <a href="goodsinfos_updt.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-pencil"></i></a>
    <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=goodsinfos" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                            </div>
 </td>
  </tr>
  	<?php
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='goodsinfos_list.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 ><a href="goodsinfos_list.php?pagecurrent=<?php echo $fyi;?>"><?php echo $fyi;?></a></li> 
	 <?php
	 }
	 ?>
	 <li><a href="goodsinfos_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
