...
if ($addnew=="1" )
{
	...
	$sql="insert into enterprisehire(signupby,stationnumbers,stationnamec,qualificationrequirement,agerequirement,enterprisenamec,lianxitel,enterpriseaddress) values('$signupby','$stationnumbers','$stationnamec','$qualificationrequirement','$agerequirement','$enterprisenamec','$lianxitel','$enterpriseaddress') ";
	mysql_query($sql);
	...
	function check()
{
	...
	function gow()
	{
		location.href='enterprisehireadd.php?jihuabifffanhao='+document.form1.jihuabifffanhao.value+"&id=<?php echo $_GET["id"]?>";
	}
</script>
