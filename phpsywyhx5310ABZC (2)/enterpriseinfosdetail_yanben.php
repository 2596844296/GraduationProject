...
<tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" class='hsgqiehuanshitu'  /> <input type=button name=Submit52 value=打印 onClick="javascript:window.print()" class='hsgqiehuanshitu' /> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 onClick="javascript:OpenScript('hsgpinglun.php?biao=enterpriseinfos&id=<?php echo $id;?>',500,200)" class='hsgqiehuanshitu'  /><input type=button name=Submit52 value=收藏 onClick="javascript:location.href='jrsc.php?id=<?php echo $id;?>&biao=enterpriseinfos&ziduan=enterprisenamec';" class='hsgqiehuanshitu'  /></td></tr>
