...
<body>
    <div id="body">
        ...
        <div class="barboxs">
            <button class="btn btn-success pull-left" data-toggle="tooltip" title="" data-placement="right" onClick="location.href='yonghuzhuce_listxls.php';" style="cursor:pointer"
           ...
           <div class="leftbox" >
			<form action="" method="post">
			 <div class="leftbox" >
              	  <div class='liselect'><input name="zhanghao" type="text" id="zhanghao" class="form-control example-typeahead" placeholder='账号' style='width:120px;' /></div><div class='liselect'><select id='xingbie' name='xingbie' class='form-control'><option value="">所有</option><option value="男">男</option><option value="女">女</option></select></div>
                <div class="liselect ">
         ...
         <div class="push">
            <button class="btn btn-success pull-left" onClick="location.href='yonghuzhuce_add.php';"><i class="fa fa-plus"></i> 发布新数据 </button>
        </div> 
 <div class="tablebox">
...
<table class="table table-bordered table-hover">
  <tr>
	...
	<input name="tablename" type="hidden" id="tablename" value="yonghuzhuce" /><input name="comew" type="hidden" id="comew" value="yonghuzhuce_list" />
	</th>
	<th >序号</th>
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
	...
	<div class="btn-group">
<a href="yonghuzhucedetail.php?id=<?php echo mysql_result($query,$i,id);?>" target="_blank" class='btn btn-xs btn-info' data-toggle='tooltip' data-placement='top' title='前台预览'><i class='fa fa-info-circle'></i></a>
    <a href="yonghuzhuce_updt.php?id=<?php echo mysql_result($query,$i,"id");?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-pencil"></i></a>
    <a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=yonghuzhuce" onClick="return confirm('真的要删除？')" class="btn btn-xs btn-danger" data-toggle="tooltip"  data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                            </div>
 </td>
  </tr>
  	<?php
...
?>
 ...
 <div class="fy">
	 ...
	 {
	 	$t=$pagecurrent-1;
	 	echo "<li><a href='yonghuzhuce_list.php?pagecurrent=".$t."'>&laquo;</a></li>";
	 }
	 ...
	 ?>
	 <li><a href="yonghuzhuce_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">&raquo;</a></li>
